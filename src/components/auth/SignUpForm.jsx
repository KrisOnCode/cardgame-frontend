  ...
  return (
      ...
      <div className="w-full max-w-xs">
        <form className="bg-violet-800 dark:bg-violet-500 shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
          <h2 className='font-heading text-white'>Register</h2>
          <div className="mb-4">
            <label className="font-heading block text-white text-sm font-bold mb-2" for="username">Username:</label>
            <input 
          ...
          <div className="flex items-center justify-between">
            ...
            <a className="font-heading inline-block align-baseline font-bold text-sm text-white" href="/">
              Already Registered?
            </a>
          </div>
        </form>
